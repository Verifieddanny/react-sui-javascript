      ...
      content: (
        <div className="space-y-4">
          <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
            ...
            <p className="text-slate-300 text-sm mb-3">
              Update{" "}
              <code className="bg-slate-700 px-1 rounded text-xs">src/lib/smart-contract/client-transactions.js</code>
            </p>
            <div className="bg-slate-900/50 rounded p-3 font-mono text-xs text-slate-300 overflow-x-auto">
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
            ...
            <p className="text-slate-300 text-sm mb-3">
              Update <code className="bg-slate-700 px-1 rounded text-xs">src/lib/smart-contract/queries.js</code>
            </p>
            <div className="bg-slate-900/50 rounded p-3 font-mono text-xs text-slate-300 overflow-x-auto">
