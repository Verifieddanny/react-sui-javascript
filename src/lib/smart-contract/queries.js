...
export class ContractQueries {
  constructor() {
    ...
    const privateKey = import.meta.env.VITE_QUERY_PRIVATE_KEY || "suiprivkey1qr4uu3cpez087ml9u3lcdvp8lahlw9sal4mfkjtcukuv3y6pdtd5w0tl0zz"

    if (!privateKey) {
      throw new Error("Please set VITE_QUERY_PRIVATE_KEY in your environment variables to use query functions")
    }
    ...
    try {
      ...
      throw new Error(`Failed to initialize ContractQueries: ${error}`)
    }
  }
